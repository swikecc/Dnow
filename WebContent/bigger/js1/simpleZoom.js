...
;(function($){
	$.fn.simpleZoom = function(options){
		...
		return this.each(function(){
			...
			var mark_css = {position:"absolute", top:0, left:0, width:markSize[0]+"px", height:markSize[1]+"px", backgroundColor:"#FFF", opacity:.5, filter:"alpha(opacity=50)",  display:"none", cursor:"crosshair"};
