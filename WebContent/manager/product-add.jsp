...
<div id="whole">
	<div id="top">
        ...
        <s:include value="main/neck.jsp"></s:include>
         <div class="dao">
         	我的位置 &gt; <a href="product.jsp" >商品系统</a> &gt; 添加商品
         </div>
    </div>
    <hr style="color: #999;"/>
	...
	<div id="main">
        <table class="productadd">
        	<s:form action="adproductadd" namespace="/manager" method="post">
             	<tr>
             		<td >&nbsp; </td>
            		<td >商品图片</td>
            		<td ><s:file name="product.picture" value="请选择"/></td>
            		<td >&nbsp; </td>
                </tr>
                <tr>
                    <td ></td>
                ...
                <tr>
                	<td ></td>
                    <td ></td>
                    <td ><s:submit name="submit" value="确认添加"/><s:reset name="reset" value="重新填写"/></td>
                    <td ></td>
                </tr>
            </s:form>
        </table>
