...
<div id="whole">
	<div id="top">
        ...
        <s:include value="main/neck.jsp"></s:include>
         <div class="dao">
         	我的位置 &gt; <a href="adorderhistory?page=1&lowstate=3&upstate=5" >订单系统</a> &gt; 处理已发货订单
         </div>
    </div>
    <hr style="color: #999;"/>
...
<div id="main">
	...
	<table>
    	<caption>已发货的订单列表</caption>
    	<s:form action="adorderget" namespace="/manager" method="post">
        <tr>
        	<td width="16%">订单号</td>
            <td width="8%">用户名</td>
            <td width="16%">完成时间</td>
