...
<title>处理等待发货的订单成功</title>
<link rel="stylesheet" type="text/css" href="../css/manager-style.css"/>
<script type="text/javascript">
	setTimeout("location.href='adorderhistory?page=1&lowstate=1&upstate=1'",5000);
	var count=4;
	setInterval("document.getElementById('jump').innerHTML='处理等待发货的订单成功，页面将于'+count+'秒后跳转到订单系统的页面，以便您继续操作';count=parseInt(count)-1;",1000);
</script>
...
<div id="main">
	<h2 id="jump">处理等待发货的订单成功，页面将于5秒后跳转到订单系统的页面，以便您继续操作</h2>
</div>
